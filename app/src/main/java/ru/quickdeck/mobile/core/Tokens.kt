...
object T {
    ...
    val panelScrim = Color(0xD60A0C10)        // затемнение под панелью, 84 %
    val panelCard = Color(0xB31F232B)         // невыбранная карточка, 70 %
    val panelRaised = Color(0xF2242932)       // выбранная карточка, 95 %
    val panelEdge = Color(0x24FFFFFF)         // граница на тёмном, 14 %
